...
The main color used is gray in a few different shades that is nuetral and easy on eyes.

### Typography

The main font used on the website is Montez, which is a Google Font.
...
- Social media links
- Contact form
- A direct link to my CV that opens in a new tab to optimize the user experience
